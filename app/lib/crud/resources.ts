...
export const crudResources: CrudResource[] = [
  ...
  },
  {
    ...
    deleteIdField: "id",
    columns: [
      { key: "id", label: "id", priority: "medium" },
      { key: "tenantId", label: "tenant_id", priority: "medium" },
      { key: "name", label: "name", priority: "high" },
      { key: "description", label: "description", priority: "low" },
      { key: "derivedKind", label: "derived_kind", priority: "high" },
      { key: "createdAt", label: "created_at", priority: "low" },
      { key: "updatedAt", label: "updated_at", priority: "low" },
    ],
    sampleRows: [
      {
        id: "role-publisher",
  ...
  },
  {
    ...
    columns: [
      { key: "id", label: "id", priority: "medium" },
      { key: "tenantId", label: "tenant_id", priority: "medium" },
      { key: "scopeMode", label: "scope_mode", priority: "high" },
      { key: "objectKind", label: "object_kind", priority: "medium" },
      { key: "objectType", label: "object_type", priority: "medium" },
      { key: "objectId", label: "object_id", priority: "low" },
      { key: "groupId", label: "group_id", priority: "low" },
  ...
  },
  {
    ...
    columns: [
      { key: "actionName", label: "action_name", priority: "high" },
      { key: "actionId", label: "action_id", priority: "medium" },
      { key: "objectKind", label: "object_kind", priority: "high" },
      { key: "objectType", label: "object_type", priority: "high" },
      { key: "description", label: "Description", priority: "low" },
      { key: "createdAt", label: "Created", priority: "low" },
    ],
    sampleRows: [
  ...
  },
  {
    ...
    columns: [
      { key: "tenantId", label: "tenant_id", priority: "medium" },
      { key: "subjectKind", label: "subject_kind", priority: "high" },
      { key: "subjectId", label: "subject_id", priority: "high" },
      {
        key: "permissionBlockId",
        label: "permission_block_id",
        priority: "high",
      },
      { key: "createdAt", label: "created_at", priority: "low" },
    ],
