---
title: Credentials
description: Managing password, API key, and certificate credentials for entities.
---
...
This page covers passwords and API keys. See [Certificates](/authentication/certificates) for mTLS certificate credentials, CA files, CRL, OCSP, and runtime lookup.
