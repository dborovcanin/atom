...
Entity, resource, and policy bindings are loaded **once**. Each action is evaluated against the same binding set. This turns N database round-trips into 1-2 queries total.
